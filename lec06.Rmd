...
3. it is "right-continuous" (technical definition: $\lim\limits_{x\to x_0^+} F(x) = F(x_0)$)
...
I told you a cdf completely characterizes any distribution, which you'll have to take on faith (or buffy, if you prefer.)
